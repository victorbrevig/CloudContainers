...
Feature: Update client information
  ...
  Scenario: Client wants to update email
    ...
    Then Display success message for "bigmoney123@gmail.com"

  @tag2
  Scenario: Client wants to update phone number
    Given A client with phone number "87654321"
    When New phone number entered as "12345678" instead of "smallmoney123@gmail.com"
    Then Display success message for "12345678"
